...
public class UserAccountController {
  ...
  @PostMapping("/signup")
  public ResponseEntity<SuccessResponse> signupGnrlUser(@Valid @RequestBody GnrlUserDto gnrlUserDto) {
  ...
  public ResponseEntity<SuccessResponse> unregisterGnrlUser(@Valid @RequestBody GnrlUserDto gnrlUserDto) {
    // TODO 회원탈퇴 기능 구현
